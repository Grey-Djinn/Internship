The AreDistinct Library Helper file for "R" provides the user with three functions. Two of these functions are able to be called to aid
...
The usefull callable functions are "distinct", and "ourOutcome" Calling "distinct" will simply return the boolean value to the calling code
...
The AreDistinct.r source file must be run within the same directory containing the files you wish to work with. Please ensure this is the
case.

Be sure to add   source("AreDistinct.r")  to the top of your calling source file.

AreDistinct.r makes use of the "Hash" library package written and maintained by Christopher Brown. If you have yet to install this package,
it can be installed by typing  install.packages("Hash") in your chosen "R" console. 
